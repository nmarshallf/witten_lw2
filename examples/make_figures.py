...
def make_figure_6(fontsize1):
    ...
    # second gaussian
    mu2 = mu1 + np.array([0.001, 0.002])*np.pi
    std2 = std1 + np.array([0.001, 0.003])*np.pi
    Y = gaussian(n, mu2, std2)

    # third gaussian
    mu3 = mu1 + np.array([0.003, -0.002])*np.pi
    std3 = std1 + np.array([-0.001, 0.002])*np.pi
    ...
    plt.xticks(fontsize=fontsize1)
    plt.yticks(fontsize=fontsize1)
    plt.savefig('fig06a.eps', format='eps',bbox_inches='tight')
    ...
    plt.xticks(fontsize=fontsize1)
    plt.yticks(fontsize=fontsize1)
    plt.savefig('fig06b.eps', format='eps',bbox_inches='tight')
